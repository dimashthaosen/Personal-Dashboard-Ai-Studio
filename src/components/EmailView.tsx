  ...
  return (
    <div className="animate-fade-up max-w-[1050px] mx-auto space-y-6">
      ...
      <div className="border-b border-paper-3 pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="font-serif text-2xl font-normal text-[#1a1612]">Syllabus Mail Inbox</h2>
          <p className="font-serif italic text-xs text-ink-405 mt-1 pl-0.5">
            Synchronised school inbox messages, student briefs, and pointwise AI-drafted replies.
          </p>
        </div>
        ...
        <div className="lg:col-span-7 bg-[#fcf9f3] border border-[#e1d8c6] rounded-[18px] p-6 shadow-[0_4px_16px_-6px_rgba(26,22,18,0.08)] space-y-5">
          {selectedEmail ? (
            <div className="space-y-5">
              ...
              {/* Mail Body snippet */}
              <div className="bg-[#f3ede2] p-5 rounded-[12px] border border-[#e1d8c6] text-xs text-[#4a4540] leading-relaxed font-sans min-h-24">
              ...
              {summaryOutput && (
                <div className="bg-[#fcf9f3] border border-[#e1d8c6] rounded-[14px] p-4 shadow-sm space-y-2.5 animate-fade-up">
                  <h4 className="font-mono text-[9px] text-[#2d5a4a] font-bold uppercase tracking-wider flex items-center gap-1.5">
                    <Sparkles className="w-3.5 h-3.5 text-[#2d5a4a]" />
                    Interactive Bullet Analysis
                  </h4>
                  <div className="text-xs text-[#4a4540] leading-relaxed font-serif italic whitespace-pre-wrap pl-1 border-l-2 border-[#2d5a4a]/40">
                    {summaryOutput}
                  </div>
                </div>
              )}
